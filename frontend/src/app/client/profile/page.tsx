...
import { User, Mail, Phone, FileText, MapPin, Briefcase, Loader2, ShieldCheck, Lock, CheckCircle2 } from 'lucide-react';
    ...
    <div className="max-w-4xl mx-auto py-8 px-4">
      <div className="flex items-center justify-between mb-8">
        <div>
          ...
          <p className="text-xs text-slate-500 dark:text-slate-400 mt-1">Manage your account and view verified credentials</p>
        </div>
        {isKycVerified ? (
          <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-emerald-500/10 border border-emerald-500/30 text-emerald-600 dark:text-emerald-400 text-xs font-bold">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input type="email" value={formData.email} readOnly className="pl-10 pr-9 w-full rounded-lg border border-gray-300 dark:border-gray-600 bg-gray-50 dark:bg-gray-700/50 px-4 py-2 text-gray-500 cursor-not-allowed" />
            ...
            <h3 className="col-span-full text-lg font-medium text-gray-800 dark:text-gray-200 border-b border-gray-200 dark:border-gray-700 pb-2 mt-4">DigiLocker KYC Credentials</h3>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input type="text" value={formData.pan} readOnly className="pl-10 pr-9 w-full rounded-lg border border-gray-300 dark:border-gray-600 bg-gray-50 dark:bg-gray-700/50 px-4 py-2 text-gray-900 dark:text-white font-mono font-bold cursor-not-allowed uppercase" />
                <div className="absolute inset-y-0 right-0 pr-3 flex items-center pointer-events-none"><Lock className="h-4 w-4 text-gray-400" /></div>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input type="text" value={formData.aadhaar} readOnly className="pl-10 pr-9 w-full rounded-lg border border-gray-300 dark:border-gray-600 bg-gray-50 dark:bg-gray-700/50 px-4 py-2 text-gray-900 dark:text-white font-mono font-bold cursor-not-allowed" />
                <div className="absolute inset-y-0 right-0 pr-3 flex items-center pointer-events-none"><Lock className="h-4 w-4 text-gray-400" /></div>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input type="text" value={formData.category} readOnly className="pl-10 pr-9 w-full rounded-lg border border-gray-300 dark:border-gray-600 bg-gray-50 dark:bg-gray-700/50 px-4 py-2 text-gray-700 dark:text-gray-300 cursor-not-allowed font-medium" />
                <div className="absolute inset-y-0 right-0 pr-3 flex items-center pointer-events-none"><Lock className="h-4 w-4 text-gray-400" /></div>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  readOnly
                  disabled
                  className="pl-10 pr-9 w-full rounded-lg border border-gray-300 dark:border-gray-600 bg-gray-50 dark:bg-gray-700/50 px-4 py-2 text-gray-700 dark:text-gray-300 cursor-not-allowed font-medium"
                />
                <div className="absolute inset-y-0 right-0 pr-3 flex items-center pointer-events-none"><Lock className="h-4 w-4 text-gray-400" /></div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-4 col-span-full md:col-span-1">
              <div>
                ...
                <input type="text" value={formData.country} readOnly className="w-full rounded-lg border border-gray-300 dark:border-gray-600 bg-gray-50 dark:bg-gray-700/50 px-4 py-2 text-gray-500 cursor-not-allowed" />
              </div>
              <div>
