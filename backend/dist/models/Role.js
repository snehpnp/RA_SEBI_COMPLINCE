...
}, { ..._schemaOptions_1.baseSchemaOptions, collection: 'Role' });
// Virtual relations
exports.RoleSchema.virtual('permissions', {
    ref: 'RolePermission',
    localField: '_id',
    foreignField: 'roleId'
});
exports.Role = mongoose_1.default.models.Role || mongoose_1.default.model('Role', exports.RoleSchema, 'Role');
