...
exports.PlanSchema.virtual('tenant', {
    ref: 'Tenant',
    localField: 'tenantId',
    foreignField: '_id',
    justOne: true
});
exports.PlanSchema.virtual('category', {
    ref: 'PlanCategory',
    localField: 'categoryId',
    foreignField: '_id',
    justOne: true
});
exports.PlanSchema.virtual('subscriptions', {
    ref: 'Subscription',
    localField: '_id',
    foreignField: 'planId'
});
exports.Plan = mongoose_1.default.models.Plan || mongoose_1.default.model('Plan', exports.PlanSchema, 'Plan');
