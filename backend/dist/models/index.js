...
Object.defineProperty(exports, "OccupationSchema", { enumerable: true, get: function () { return Occupation_1.OccupationSchema; } });
...
Object.defineProperty(exports, "FaqSchema", { enumerable: true, get: function () { return Faq_1.FaqSchema; } });
/**
...
function registerTenantModels(connection) {
    const models = {
        ...
        Faq: (connection.models.Faq || connection.model('Faq', Faq_1.FaqSchema, 'Faq'))
    };
    return {
        ...models,
