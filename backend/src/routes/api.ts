...
router.post('/admin/verify-digio', authenticateJWT, requireRoles(['ADMIN', 'SUPER_ADMIN', 'COMPLIANCE_OFFICER', 'RESEARCHER', 'PRINCIPAL_OFFICER']), verifyDigioConnection);
router.post('/verify-digio', authenticateJWT, requireRoles(['ADMIN', 'SUPER_ADMIN', 'COMPLIANCE_OFFICER', 'RESEARCHER', 'PRINCIPAL_OFFICER']), verifyDigioConnection);
router.post('/digio/verify', authenticateJWT, requireRoles(['ADMIN', 'SUPER_ADMIN', 'COMPLIANCE_OFFICER', 'RESEARCHER', 'PRINCIPAL_OFFICER']), verifyDigioConnection);
